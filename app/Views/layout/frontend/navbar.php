...
<nav id="navbar" class="navbar">
    <ul>
        ...
        <?php if (isset($login_check) && $login_check['login_status']) : ?>
            <li class="dropdown cstr <?= $login_check['user']['customer_id']; ?>">
                ...
                <ul class="dropdown dropdown-menu mt-1 special-dropdown cart-dropdown py-2" style="right: -82px; width: 340px;">
                    ...
                    <li><a id="cartstatuslink" href="<?= base_url('/cart'); ?>" class="text-bold text-black" style="padding-bottom: 12px; padding-top: 12px;">Lihat semua</a></li>
                </ul>
            </li>
